    ...
    <div className='px-[32px] '>
      <div className='flex items-center justify-between py-[30px] border-b-[1px] border-[#E9EBF0] '>
        <div className='flex gap-4 items-center'>
          <Image src={'/images/avatar.jpeg'} alt={'Avatar'} width={40} height={40} className='rounded-full p-[3px] ring-2 ring-[#3B82F6]'/>
          <div className='flex flex-col gap-[2px]'>
            <p className='text-[#1F2633] font-bold text-[12px]'>Nancy Martino</p>
